...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Jeton::class, mappedBy="user", cascade={"persist", "remove"})
    ...
    {
        return (string) $this->passwordconf;
    }

    public function setPasswordconf(string $passwordconf): self
    {
